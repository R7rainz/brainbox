      ...
      <nav className="z-20 w-full absolute top-0 left-0 bg-transparent">
        <div>
          <div className="flex flex-wrap items-center justify-between py-4 gap-6 relative">
            ...
            ></div>
            <div
              className="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-gray-900 shadow-2xl justify-end w-full invisible opacity-0 translate-y-1 absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
            ...
            >
              <div className="text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                  <li>
                    <a
                      href="#features"
                      className="block md:px-4 transition hover:text-red-500"
                    >
                      <span>Features</span>
                    </a>
                  </li>
              ...
              <div className="mt-12 lg:mt-0">
                <a
                  href="/dashboard"
                  className="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-red-500 before:transition 
